...
public class SweetController {
	@Autowired
	SweetRepo doctorRepo;
	
	@GetMapping("/doctor/find")
	public Sweet findById(@RequestParam int id) {
		
		
		 Sweet doctor =doctorRepo.findById(id).get();
	...
	public String addProduct(@RequestParam ("dietFile") MultipartFile myFile,
		...
		try {
			Sweet prdImage = new Sweet(name,degree,spl,exp,address,phone,
	...
	public List<Sweet> deleteDoctor(@RequestParam int id){
	...
	public List<Sweet> getAllProducts(){
		
		List<Sweet> drList = new ArrayList<Sweet>();
		
		List<Sweet> resDrList = doctorRepo.findAll();
		Sweet doctor = null;
